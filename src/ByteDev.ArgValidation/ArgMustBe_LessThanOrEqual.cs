...
namespace ByteDev.ArgValidation
{
    public static partial class ArgMustBe
    {
        ...
        {
            if (param > value)
                ExceptionThrower.ThrowLessThanOrEqualException(value.ToString(), paramName);
        }
        ...
        {
            if (param > value)
                ExceptionThrower.ThrowLessThanOrEqualException(value.ToString(CultureInfo.InvariantCulture), paramName);
        }
